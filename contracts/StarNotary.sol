...
contract StarNotary is ERC721 {
    // contract address rinkeby: 0x8bBE7b77829cf724811407cc094b4fCC78E11266
    // Star data
    struct Star {
        string name;
    }
    ...
    string constant public name = 'Star Gaze';
    string constant public symbol = 'STGZ';
    ...
    function lookUptokenIdToStarInfo (uint _tokenId) public view returns (string memory) {
        ...
        //require(bytes(tokenIdToStarInfo[_tokenId].name));
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(ownerOf(_tokenId) == msg.sender, "Only owner can transfer star!");
